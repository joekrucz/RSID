      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="btn-group">
              <button 
                class="btn btn-sm {currentView === 'list' ? 'bg-neutral text-neutral-content border-neutral' : 'btn-outline border-neutral text-neutral'}"
              ...
              <button 
                class="btn btn-sm {currentView === 'pipeline' ? 'bg-neutral text-neutral-content border-neutral' : 'btn-outline border-neutral text-neutral'}"
      ...
      {#if pagination && pagination.total_pages > 1}
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 p-4 bg-base-100 rounded-lg border border-base-300">
          ...
          <div class="flex items-center space-x-2">
            <!-- Previous Button -->
            <button 
              class="btn btn-sm btn-outline border-neutral text-neutral"
            ...
            <div class="flex items-center space-x-1">
              {#each Array.from({length: Math.min(5, pagination.total_pages)}, (_, i) => {
                ...
                <button 
                  class="btn btn-sm {page === pagination.current_page ? 'bg-neutral text-neutral-content border-neutral' : 'btn-outline border-neutral text-neutral'}"
