      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center space-x-2">
            <div class="btn-group">
              <button 
                class="btn {currentView === 'pipeline' ? 'bg-gray-200 text-gray-900 border-gray-200' : 'btn-outline border-gray-300 text-gray-700'}"
              ...
              <button 
                class="btn {currentView === 'list' ? 'bg-gray-200 text-gray-900 border-gray-200' : 'btn-outline border-gray-300 text-gray-700'}"
