    ...
    <div class="card bg-base-100 shadow-xl mb-8">
      <div class="card-body">
        ...
        <div class="space-y-4">
          ...
          {#if recent_activity.notes.length === 0 && recent_activity.todos.length === 0 && recent_activity.files.length === 0 && (!recent_activity.clients || recent_activity.clients.length === 0) && (!recent_activity.grant_applications || recent_activity.grant_applications.length === 0) && (!recent_activity.companies || recent_activity.companies.length === 0) && (!recent_activity.grant_competitions || recent_activity.grant_competitions.length === 0) && (!recent_activity.people || recent_activity.people.length === 0)}
            <div class="text-center py-8">
              <div class="text-4xl mb-4">🚀</div>
              <h3 class="text-lg font-semibold mb-2">No recent activity</h3>
              <p class="text-base-content/70">Start creating notes, todos, uploading files, managing grant applications, and working with companies to see your activity here!</p>
            </div>
          {/if}
        </div>
      </div>
